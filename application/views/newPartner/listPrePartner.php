     ...
     <?php foreach ($partners as $partner) :?>
      <tr>
        ...
        <td>  <div class="btn-group">
          <a class="btn btn-info btn-sm confirm-partner-btn" id="<?= $partner->id ?>" data-toggle="modal" data-target="#delete_modal" href="#">
          <span class="glyphicon glyphicon-ok-sign"></span></a>
          <a class="btn btn-primary btn-sm" href="<?= base_url('detailPartner/'.  $partner->id) ?>">
