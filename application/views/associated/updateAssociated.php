...
<div class="well well-lg container">
  ...
  <div class="row col-sm-12">
    <form method="POST" action="<?= base_url('associated/update'); ?>">
      ...
      <div class="col-sm-8">
        ...
        <div class="form-group row">
         <div id="validation_errors" class="container row">
          <?= form_error('name_associate','<div id="error_name_associate" class="col-sm-8 alert-warning alert-dismissible" role="alert">', '</div>') ?>
        </div>
      ...
      <div class="form-group row">
       <div id="validation_errors" class="container row">
        <?= form_error('birth_date','<div id="error_birth_date" class="col-sm-8 alert-warning alert-dismissible" role="alert">', '</div>') ?>
      </div>
    ...
    <div class="form-group row">
     <div id="validation_errors" class="container row">
       <?= form_error('rg','<p id="error_rg" class="col-sm-8 alert-warning alert-dismissible" role="alert">', '</p>') ?>
     </div>
  ...
  <div class="form-group row">
   <div id="validation_errors" class="container row">
     <?= form_error('cpf','<div id="error_cpf" class="col-sm-8 alert-warning alert-dismissible" role="alert">', '</div>') ?>
    </div>
    ...
    <div class="col-sm-8">
      <select class="form-control" name="id_payment_type" id="id_payment_type">
          ...
          <option value="<?= $pay_type['id_payment_type'] ?>"
              <?= $pay_type['id_payment_type'] == $associate->id_payment_type ? print_r("selected") : print_r("") ?> >
    ...
    <div class="col-sm-8">
      <select class="form-control" name="id_frequency" id="id_frequency">
          ...
          <option value="<?= $frequencia['id_frequency'] ?>"
              <?= $frequencia['id_frequency'] == $associate->id_frequency ? print_r("selected") : print_r("") ?> >
  ...
  <div class="col-sm-8">
    <select class="form-control" name="id_city" id="id_city">
        ...
        <option value="<?= $cidade['id_city'] ?>"
            <?= $cidade['id_city'] == $associate->id_city ? print_r("selected") : print_r("") ?> >
            <?= $cidade['name_city'] ?>
        </option>
        <?php } ?>
    </select>
