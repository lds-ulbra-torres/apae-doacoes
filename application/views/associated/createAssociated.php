...
<div class="well well-lg container">
  ...
  <div class="row col-sm-12">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="work_street" name="work_street" placeholder="Rua (Comercial)" value="<?= set_value('work_street', isset($associate->work_street) ? $associate->work_street:''); ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="number" class="form-control" id="work_street_number" name="work_street_number" placeholder="Número (Comercial)" value="<?= set_value('work_street_number', isset($associate->work_street_number) ? $associate->work_street_number:''); ?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control" id="work_street_neighborhood" name="work_street_neighborhood" placeholder="Bairro (Comercial)" value="<?= set_value('work_street_neighborhood', isset($associate->work_street_neighborhood) ? $associate->work_street_neighborhood:''); ?>">
      </div>
    </div>
  </div>
